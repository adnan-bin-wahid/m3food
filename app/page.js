      ...
      <section className="experience section-cream" id="experience">
        <div className="page-shell section-heading split-heading">
          ...
          <Reveal delay={90} className="section-heading-copy">
            <p>এক কামড়ে স্বাদ বদলায় ধাপে ধাপে—প্রথমে মিছরির নরম মিষ্টতা, এরপর চুইঝালের স্বকীয় ঝাঁঝ, আর শেষে আসে হালকা সতেজ অনুভূতি। এটাই Niyamah Attires-এর সবচেয়ে মনে থাকার মতো স্বাদ-অভিজ্ঞতা।</p>
          </Reveal>
        </div>
