...
const DEFAULT_FAQS: FaqItem[] = [
  ...
  },
  {
    ...
    a: "হ্যাঁ, আমাদের পারফিউম ১০০% নন-আলকোহলিক ও খাঁটি অর্কিড নির্যাস দিয়ে তৈরি, যা সম্পূর্ণ হালাল ও ত্বকের জন্য শতভাগ নিরাপদ। জুমার দিন ও যেকোনো অনুষ্ঠানে ব্যবহারের জন্য পারফেক্ট এবং দীর্ঘসময় সুবাস বজায় রাখে।"
  },
  {
    q: "টিউলিপ প্যাকেজে কী কী থাকছে?",
    a: "টিউলিপ প্যাকেজে থাকছে ৩টি দারুণ আকর্ষণ: ১. প্রিমিয়াম bexi কটন সালাত হিজাব, ২. ১০০% নন আলকোহলিক পারফিউম এবং ৩. সুপার কিউট টিউলিপ গিফট ব্যাগ। এটি নিজের জন্য বা প্রিয়জনকে উপহার দেওয়ার জন্য পারফেক্ট কম্বো।"
  }
];
