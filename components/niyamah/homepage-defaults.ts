...
export const HOMEPAGE_DEFAULTS = {
  hero: [
    ...
    },
    {
      id: "hijab",
      status: "active",
      eyebrow: "The Modest Silk Atelier",
      title: "Medina Silk Veils",
      highlight: "Dignified Grace",
      titleLine1: "Medina Silk Veils",
      titleLine2: "Dignified Grace",
      subheading: "Haute Hijab & Crepe",
      subtitle:
        "Breathable, non-slip luxury Medina silk engineered with superior drape for all-day comfort and modest poise.",
      description:
        "Breathable, non-slip luxury Medina silk engineered with superior drape for all-day comfort and modest poise.",
      badge: "Pure Medina Silk",
      ctaPrimary: { label: "Shop Silk Veils", href: "/category/hijab" },
      primaryButtonText: "Shop Silk Veils",
      primaryButtonLink: "/category/hijab",
      ctaSecondary: { label: "View Fabric Guide", href: "#fabric-guide" },
      productName: "Medina Silk Hijab",
      metadataLine: "Haute Hijab / Seasonal Monograph",
      cardName: "Silk Hijab",
      shortName: "Silk Veil",
      productImage: "/niyamah/editorial/hijab-drape.jpg",
      productImageAlt: "Model wearing draped emerald Medina silk hijab",
      bigWord1: "HAUTE",
      bigWord2: "HIJAB",
      theme: "emerald",
      infoItems: [
        { label: "Fabric", value: "Medina Silk" },
        { label: "Drape", value: "Fluid & Non-Slip" },
        { label: "Opacity", value: "100% Modest" },
      ],
    ...
    },
    {
      id: "attar",
      status: "active",
      eyebrow: "Artisanal Perfumery",
      title: "The Attar Vault",
      highlight: "Pure Oud & Amber",
      titleLine1: "The Attar Vault",
      titleLine2: "Pure Oud & Amber",
      subheading: "Alcohol-Free Extrait",
      subtitle:
        "Rare small-batch botanical attars distilled with ancient patience. Intimate, long-lasting sillage that develops gracefully on skin.",
      description:
        "Rare small-batch botanical attars distilled with ancient patience. Intimate, long-lasting sillage that develops gracefully on skin.",
      badge: "Pure Botanical Oil",
      ctaPrimary: { label: "Explore The Vault", href: "/category/attar" },
      primaryButtonText: "Explore The Vault",
      primaryButtonLink: "/category/attar",
      ctaSecondary: { label: "Fragrance Notes", href: "#fragrance-notes" },
      productName: "Artisanal Attar",
      metadataLine: "Pure Extrait / Small Batch",
      cardName: "Attar",
      shortName: "Oud Attar",
      productImage: "/niyamah/editorial/perfume-flacon.jpg",
      productImageAlt: "Artisanal square amber glass perfume bottle on travertine stone",
      bigWord1: "ATTAR",
      bigWord2: "SILLAGE",
      theme: "dark",
      infoItems: [
        { label: "Origin", value: "Cambodian Oud" },
