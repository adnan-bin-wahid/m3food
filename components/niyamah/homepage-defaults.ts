...
export const HOMEPAGE_DEFAULTS = {
  hero: [
    {
      ...
      productImage: "/niyamah/slider/slider-2-f.webp",
      sceneBgImage: "/niyamah/slider/global-bg-for-all-slide.webp",
      ...
      variantsList: [
        { id: "v1", num: "01", name: "Floral Set", image: "/niyamah/slider/slider-2-f.webp" },
        { id: "v2", num: "02", name: "Orchid", image: "/niyamah/slider/slider-1-f.webp" },
        { id: "v3", num: "03", name: "Blossom Tote", image: "/niyamah/slider/slider-3-f.webp" },
      ],
      colors: {
        purple: "#4a1c2a",
        lightBlue: "#faf2f4",
    ...
    },
    {
      ...
      shortName: "Orchid",
      productImage: "/niyamah/slider/slider-1-f.webp",
      sceneBgImage: "/niyamah/slider/global-bg-for-all-slide.webp",
    ...
    },
    {
      ...
      productImage: "/niyamah/slider/slider-3-f.webp",
      sceneBgImage: "/niyamah/slider/global-bg-for-all-slide.webp",
  ...
  discovery: {
    ...
    subtitle: "নামাজের হিজাব, নন আলকোহলিক পারফিউম এবং টিউলিপ গিফট প্যাকেজ।",
    placeholder: "নামাজের হিজাব, পারফিউম, টিউলিপ প্যাকেজ খুঁজুন…",
    trending: [
      "নামাজের হিজাব",
      "Pure bexi কটন",
      "নন আলকোহলিক পারফিউম",
  ...
  needs: {
    ...
    subtitle: "Pure bexi কটন নামাজের হিজাব, নন-আলকোহলিক পারফিউম ও আকর্ষণীয় টিউলিপ গিফট প্যাকেজ।",
    tiles: [
      { label: "নামাজের হিজাব", href: "#fabric-guide", icon: "sparkles", tone: "accent", badge: "হট ডিল" },
      { label: "নন আলকোহলিক পারফিউম", href: "#fragrance-notes", icon: "heart", badge: "জনপ্রিয়" },
      { label: "টিউলিপ প্যাকেজ", href: "#collections", icon: "gift", tone: "accent", badge: "উপহার" },
      { label: "সালাত হিজাব (ফ্রিল কুচি)", href: "#fabric-guide", icon: "sparkles" },
      { label: "সকল পণ্য সম্ভার", href: "#catalog", icon: "bag" },
    ],
  } satisfies NeedsData,
  ...
  trust: {
    ...
    items: [
      ...
      },
      {
        ...
        details:
          "ঢাকার ভেতরে ২৪–৪৮ ঘণ্টার মধ্যে এবং ঢাকার বাইরে ২–৩ দিনের মধ্যে নির্ভরযোগ্য কুরিয়ারের মাধ্যমে নিরাপদে আপনার দোরগোড়ায় পৌঁছে দেওয়া হয়।",
      },
      {
        id: "returns",
        icon: "refresh",
      ...
      },
      {
        ...
        details:
          "আমাদের কাপড়ের কোয়ালিটি সবসময়ই বেস্ট হবে ইনশাআল্লাহ। Pure bexi কটন সালাত হিজাব ও অ্যালকোহল মুক্ত খাঁটি পারফিউম নিজস্ব তত্ত্বাবধানে যাচাইকৃত।",
      },
      {
        id: "support",
        icon: "message",
  ...
  editorial: {
    ...
    cards: [
      {
        eyebrow: "নামাজের হিজাব • Pure bexi Cotton",
        title: "সালাত হিজাব (ফ্রিল কুচি)",
        description:
          "১০০% অর্জিনাল বেক্সি ভয়েল হিজাব। নিচে কুচি দিয়ে ফ্রিল ডিজাইন, থুতনিতে ও মাথায় আলাদা কাপড়। সাইজ: ফ্রন্ট ৪৩, পেছনে ৫২।",
        href: "#fabric-guide",
        cta: "হিজাব কালেকশন দেখুন",
      ...
      },
      {
        ...
        description:
          "১০০% অ্যালকোহল মুক্ত খাঁটি অর্কিড সুবাস—লং লাস্টিং মন মাতানো হালাল সুবাস।",
      ...
      {
        eyebrow: "টিউলিপ প্যাকেজ • Exclusive Gift Set",
        title: "টিউলিপ গিফট প্যাকেজ",
        description:
          "প্রিমিয়াম bexi কটন সালাত হিজাব + নন আলকোহলিক পারফিউম + সুপার কিউট টিউলিপ গিফট ব্যাগ।",
        href: "#collections",
        cta: "প্যাকেজ দেখুন",
        gradient: "from-[#EAF4D5] via-[#FAF7EE] to-[#EFE6D2]",
        decoration: "GIFT",
    ...
    items: [
      {
        ...
        name: "সাদিয়া ইসলাম",
        rating: 5,
        body: "নামাজের হিজাবটি হাতে পেয়ে সত্যিই মুগ্ধ হয়েছি। থুতনিতে ও মাথায় আলাদা কাপড় থাকায় কানের চুল একদম বের হয় না। ফেব্রিকটি অত্যন্ত আরামদায়ক।",
        location: "ধানমন্ডি, ঢাকা",
        purchasedItem: "নামাজের হিজাব — Pure bexi কটন",
      },
      {
        id: "t2",
        name: "তানভীর আহমেদ",
        rating: 5,
        body: "নন আলকোহলিক পারফিউমটির ঘ্রাণ অসাধারণ আভিজাত্যপূর্ণ। কাপড়ে ব্যবহারের পর পুরো দিন সুবাস ছিল। প্যাকেজিং এবং দ্রুত ডেলিভারির জন্য ধন্যবাদ।",
        location: "জিইসি মোড়, চট্টগ্রাম",
        purchasedItem: "নন আলকোহলিক পারফিউম",
      },
      {
        id: "t3",
        name: "ফাতেমা তুজ জোহরা",
        rating: 5,
        body: "আমার মায়ের জন্য টিউলিপ প্যাকেজটি উপহার নিয়েছিলাম। সালাত হিজাব, পারফিউম ও কিউট ব্যাগের কোয়ালিটি দেখে মা খুব খুশি হয়েছেন।",
        location: "উপশহর, সিলেট",
        purchasedItem: "টিউলিপ প্যাকেজ",
      },
    ],
