...
const collection = [
  ...
  { id: "orchid-perfume", name: "অর্কিড পারফিউম", category: "প্রিমিয়াম অ্যাটার কালেকশন", title: "অর্কিডের ঘ্রাণে", highlight: "প্রতিটি মুহূর্ত", subtitle: "নন-আলকোহলিক পারফিউম", image: "slider-1-f.png", box: "25 90 1066 1265", size: [1122,1402], script: ["More Than a Scent", "A Kinder You ♡"], card: "আমাদের অ্যাটার কালেকশন", note: "নারীত্বের এক কোমল প্রকাশ", specs: [["ধরণ","নন-আলকোহলিক অ্যাটার"],["ঘ্রাণ","অর্কিড ব্লুম"],["স্টাইল","সফট ফেমিনিন ফ্লোরাল"]], features: ["ফ্রেশ ফ্লোরাল", "দীর্ঘস্থায়ী", "গিফটের জন্য পারফেক্ট"] },
...
export function HeroSlider({ slides, autoPlayMs = 8500, className = "" }: { slides: HeroSlideData[]; autoPlayMs?: number; className?: string }) {
  ...
  return <section className={`nh-hero ${className}`} aria-label="নিয়ামাহ কালেকশন" aria-roledescription="carousel" lang="bn"
    ...
    <picture className="nh-scene" aria-hidden="true"><source media="(max-width: 767px)" srcSet="/niyamah/slider/mobile%20version.png"/><img src="/niyamah/slider/global%20bg%20for%20all%20slide.png" alt="" fetchPriority="high"/></picture>
