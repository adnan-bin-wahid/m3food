...
export const CURATED_DROP_PRODUCTS: CuratedDropProduct[] = [
  ...
  { id: "tulip-gift-package", name: "টিউলিপ গিফট প্যাকেজ", nameEn: "Tulip Gift Package", category: "A GESTURE OF LOVE", image: "/niyamah/curated-drop/prod-3.png", description: "ভালোবাসার মানুষকে, যত্নে বেছে দেওয়া।", price: 1350, href: "#order" },
];
