const BOXES:Record<string,{viewBox:string;width:number;height:number}>={
 '/niyamah/order/prod-1.webp':{viewBox:'33 94 1051 1259',width:1122,height:1402},
 '/niyamah/order/prod-2.webp':{viewBox:'306 13 698 996',width:1328,height:1184},
 '/niyamah/order/prod-3.webp':{viewBox:'218 0 692 1148',width:1080,height:1360},
