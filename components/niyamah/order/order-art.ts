...
export const ORDER_ART: Record<string, string> = {
  ...
  'NYM-SH-001': '/niyamah/variant/hejab/1.webp',
  'NYM-SH-002': '/niyamah/variant/hejab/2.webp',
  'NYM-SH-003': '/niyamah/variant/hejab/3.webp',
  'NYM-SH-004': '/niyamah/variant/hejab/4.webp',
  'NYM-SH-005': '/niyamah/variant/hejab/5.webp',
  'NYM-SH-006': '/niyamah/variant/hejab/6.webp',

  // Perfume variants (1 to 6)
  'NYM-PRF-001': '/niyamah/variant/perfume/1.webp',
  'NYM-PRF-002': '/niyamah/variant/perfume/2.webp',
  'NYM-PRF-003': '/niyamah/variant/perfume/3.webp',
  'NYM-PRF-004': '/niyamah/variant/perfume/4.webp',
  'NYM-PRF-005': '/niyamah/variant/perfume/5.webp',
  'NYM-PRF-006': '/niyamah/variant/perfume/6.webp',

  // Tulip Gift Package
  'NYM-TLP-001': '/niyamah/order/prod-3.webp',
};
export function orderArt(product:{name:string;slug?:string},sku?:string){
 ...
 if(/perfume|attar|orchid|পারফিউম|আতর/.test(text))return '/niyamah/order/prod-1.webp';
 if(/gift|tulip|গিফট|উপহার/.test(text))return '/niyamah/order/prod-3.webp';
 if(/hijab|salat|salah|prayer|হিজাব|নামাজ/.test(text))return '/niyamah/order/prod-2.webp';
