...
export const DEMO_REVIEWS: CustomerReview[] = [
  { id: "demo-samiya", name: "সামিয়া ইসলাম", location: "ঢাকা", rating: 5, verified: true,
    text: "আল্লাহর হুকুম মেনে পর্দায় চলার পথে নিয়ামাহ আমার জন্য সত্যিই বিশেষ হয়ে উঠেছে। কাপড়ের কোয়ালিটি, ফিট, আর কমফোর্ট—সবকিছুই অসাধারণ। নামাজের সময় এদের হিজাব ব্যবহার করে আমি সত্যি স্বস্তি পাই। জাযাকাল্লাহু খাইর ♡",
    avatar: portrait(355, 585, 116), product: { name: "নামাজের হিজাব", image: "/niyamah/reviews/prod-2.webp", href: "#order" }, signature: "Comfort\nin Worship ♡" },
  { id: "demo-nusrat", name: "নুসরাত জাহান", location: "চট্টগ্রাম", rating: 5, verified: true,
    text: "কোয়ালিটি এত ভালো যে বারবার অর্ডার করতে ইচ্ছা করে। ডিজাইন সিম্পল কিন্তু খুবই এলিগ্যান্ট। নিয়ামাহ সত্যিই বিশ্বাসের একটি নাম!",
    avatar: portrait(882, 372, 82), product: { name: "প্রেয়ার হিজাব", image: "/niyamah/reviews/prod-2.webp", href: "#order" }, signature: "Made for\nyour moments ♡" },
  { id: "demo-rabeya", name: "রাবেয়া আক্তার", location: "সিলেট", rating: 5, verified: true,
    ...
    avatar: portrait(1248, 372, 82), product: { name: "টিউলিপ প্যাকেজ", image: "/niyamah/reviews/prod-3.webp", href: "#order" }, signature: "A little gift,\na lot of love ♡" },
  { id: "demo-tanjila", name: "তানজিলা হক", location: "রাজশাহী", rating: 5, verified: true,
    text: "বাইরেও, ইবাদতেও—সব জায়গায় নিয়ামাহ আমাকে কনফিডেন্ট রাখে। কাপড়টা এতটাই আরামদায়ক!",
    avatar: portrait(882, 622, 82), product: { name: "দৈনন্দিন হিজাব", image: "/niyamah/reviews/prod-2.webp", href: "#order" }, signature: "Beauty in\neveryday grace ♡" },
  { id: "demo-farha", name: "ফারহা তাসনিম", location: "খুলনা", rating: 5, verified: true,
    ...
    avatar: portrait(1248, 622, 82), product: { name: "অর্কিড পারফিউম", image: "/niyamah/reviews/prod-1.webp", href: "#order" }, signature: "A scent\nto remember ♡" },
];
